...
export default function Mint() {
    ...
    const contractAddress = "0xf6aB5ec244845B35AE66bA5c3B6a009Ed7A21c0B"
    ...
    //     const num = await contractInst.getNum1()
    ...
    //     let overRide = {
    //          from :mainAddress ,value:ethers.utils.parseUnits('11', 'ether'),  gasLimit: 250000 , gasPrice:ethers.utils.parseUnits('500', 'gwei')
    //     }
    //     // const numberIs = await contractInst.setNum(6, {gasLimit: 250000 , gasPrice:ethers.utils.parseUnits('500', 'gwei'),value: utils.parseEther("1.0"), chainId:23 })
    //     const numberIs = await contractInst.setNum1(6,overRide)
    //     readData()
    // }
...
{/* //////////////////////// */}
        ...
        <div className="col">
            <img className="img-fluid new1 my-10" style={{width : "50%"}} src="3.png"  alt="marconi"/>
